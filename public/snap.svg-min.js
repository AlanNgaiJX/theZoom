            ...
            d = (function() {
                ...
                function q(a, b) {
                    if (null == b) {
                        ...
                        (b = d._.rgTransform.test(b)
                            ...
                            : o(b)),
                            f(b, "array") &&
                                (b = d.path ? d.path.toString.call(b) : K(b)),
                            (a._.transform = b);
                ...
                function r(a) {
                    ...
                    var c =
                        ...
                        f = null == e ? !1 : e.node;
                    return (
                        f || (f = x("defs", c.node).node), (d._.someDefs = f), f
                    );
                }
                function s(a, b, c) {
                    function d(a) {
                    ...
                    if (a && "svg" == a.tagName) {
                        ...
                        (c = new u(a)),
                            ...
                            d ||
                                ((d = e("desc")),
                                d.appendChild(
                                    I.doc.createTextNode("Created with Snap")
                                ),
                ...
                (d._.getSomeDefs = r),
                    ...
                    (d.selectAll = function(a) {
                        for (
                            var b = I.doc.querySelectorAll(a),
                                c = (d.set || Array)(),
                                e = 0;
                            e < b.length;
                            e++
                            ...
                            (a.getBBox = function(a) {
                                ...
                                return a
                                    ? ((c.bboxwt = d.path.get[b.type]
                                      ...
                                      d._.box(c.bboxwt))
                                    : ((b.realPath = (
                                          d.path.get[b.type] || d.path.get.deflt
                                      )(b)),
                                      (c.bbox = d.path.getBBox(
                                          d.path.map(b.realPath, b.matrix)
                                      )),
                                      d._.box(c.bbox));
                            });
                        var j = function() {
                    ...
                    (function() {
                        function a(a) {
                            return function() {
                                ...
                                return "none" == c
                                    ? c
                                    : d(I.doc.getElementById(c.match(W)[1]));
                            };
                        }
                        function c(a) {
                            return function(c) {
            ...
            d.plugin(function(a, b) {
                ...
                function E(a, b, c, d, e, f, g, h) {
                    ...
                    return (
                        ...
                        m > 0 &&
                            1 > m &&
                            ((i = D(a, b, c, d, e, f, g, h, m)),
                            p.push(i.x),
                            o.push(i.y)),
                        n > 0 &&
                            1 > n &&
                            ((i = D(a, b, c, d, e, f, g, h, n)),
                            p.push(i.x),
                            o.push(i.y)),
                        (j = f - 2 * d + b - (h - 2 * f + d)),
                        (k = 2 * (d - b) - 2 * (f - d)),
                ...
                (e.push = function() {
                    ...
                    (e.splice = function(a, e) {
                        ...
                        for (f = 0; f < j + g.length; f++)
                            this.items[a + f] = this[a + f] =
                                j > f ? i[f] : g[f - j];
                        for (
                            f = this.items.length = this.length -= e - j;
                            this[f];
